...
const PATH = "/istanbul/besiktas-led-ekran-kiralama";
const TITLE = "Beşiktaş LED Ekran Kiralama";
const DESCRIPTION =
  "Beşiktaş’ta etkinlik ve kurumsal organizasyonlar için LED ekran kiralama. Indoor/outdoor panel seçimi, kurulum ve teknik takip.";
...
export default function BesiktasPage() {
  ...
  const graph = {
    ...
    "@graph": [
      ...buildServiceGraph({
        slug: "besiktas-led-ekran-kiralama",
        serviceName: TITLE,
        path: PATH,
        title: TITLE,
        description: DESCRIPTION,
  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="mt-4 text-white/80 text-lg leading-relaxed max-w-3xl">
            Beşiktaş’ta etkinlik kurulumu çoğu zaman dar yükleme alanları, belirli giriş saatleri ve yoğun trafikle
      ...
      <Section eyebrow="Öne çıkan" title="Beşiktaş’ta En Çok Tercih Edilen Kurulumlar">
